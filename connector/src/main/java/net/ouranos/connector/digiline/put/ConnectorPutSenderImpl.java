...
@Service
@Slf4j
public class ConnectorPutSenderImpl implements ConnectorPutSender {
    ...
    @Override
    public ConnectorPutRequestReceivedData send(ConnectorPutRequestSendData data) {
        ...
        return new ConnectorPutRequestReceivedData(data.dataModelName(), result.getBody(), data.tracking(), data.queryString(), result.getStatusCode(), filteredHeaders);
    }
}
